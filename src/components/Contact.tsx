...
const links = [
  {
    label: "Twitter",
    display: "@SiddharthC30",
    href: "https://x.com/SiddharthC30",
    icon: <TwitterIcon />,
  },
  {
    label: "GitHub",
    display: "github",
    href: "https://github.com/siddharthc30",
    icon: <GitHubIcon />,
  },
  {
    label: "LinkedIn",
    display: "linkedin",
    href: "https://www.linkedin.com/in/sai-siddharth-cilamkoti/",
    icon: <LinkedInIcon />,
  },
  {
    label: "Email",
    display: "email",
    href: "mailto:siddharthcilamkoti@gmail.com",
    icon: <EmailIcon />,
  },
];
...
export function Contact() {
  return (
    <section id="contact" className="border-t border-border pt-10 pb-16 sm:pt-12 sm:pb-20">
